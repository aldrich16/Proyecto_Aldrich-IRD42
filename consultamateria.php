...
<div class="btn-group">
 ...
 <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="http://localhost//bd/consultaalumnos.php">Alumnos</a></li>
    <li><a class="dropdown-item" href="http://localhost//bd//consultamaestro.php">Maestros</a></li>
...
<?php 
       ...
       <td>
      <a href="modificarmateria.php?id=<?php echo $row['matricula'];?>" >  
...
?>
<a type="submit" class="btn btn-outline-success" href="agregarmateria.html">Agregar Materia
