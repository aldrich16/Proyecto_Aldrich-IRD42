...
<?php 
$id = $_GET["id"];
		$sql="SELECT * from maestros where matricula='$id'";
		$result=mysqli_query($conexion,$sql);

		while($row=mysqli_fetch_array($result)){
		 ?>
<form action="formulario_modmaestro.php" method="POST">
    <h1>Maestro</h1>
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="text" value="<?php echo $row['materia'] ?>" name="txtmateria" class="form-control">
        </div>
